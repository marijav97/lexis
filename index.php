...
<section class="banner" role="banner">
    ...
    <div class="header-content clearfix"> <a class="logo" href="index.php">LEXIS</a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          <?php 
          $menu="SELECT * FROM menu WHERE flag in(1,2)";
  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1">
      <div class="banner-text text-center" id="banner">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="submit" id="sendReg" name="sendReg" class="submitLogin btn btn-large" onsubmit=provera() value="Register"><br/>
